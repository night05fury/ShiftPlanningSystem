    ...
    <div className="container mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded shadow-md">
          {" "}
          {/* Increased padding for the user management section */}
          <h2 className="text-2xl font-bold mb-4">User Management</h2>{" "}
          {/* Increased font size for table titles */}
          <div className="overflow-x-auto">
            ...
            <table className="min-w-full bg-white border border-gray-300">
              <thead>
                <tr>
                  <th className="border px-6 py-4 text-lg">Name</th>{" "}
                  {/* Increased padding and text size */}
                  <th className="border px-6 py-4 text-lg">Email</th>{" "}
                  {/* Increased padding and text size */}
                  <th className="border px-6 py-4 text-lg">Actions</th>{" "}
                  {/* Increased padding and text size */}
                </tr>
              </thead>
              <tbody>
        ...
        <div className="bg-white p-8 rounded shadow-md">
          {" "}
          {/* Increased padding for the availability section */}
                      ...
                      (day, i) => {
                        const availability = availabilities.find(
                          (avail) =>
                            ...
                            moment(avail.date).day() === i + 1
                        );
                        return (
                          <td key={day} className="border px-6 py-4 text-lg">
                            {availability
                              ? `${getTimeInSelectedZone(
